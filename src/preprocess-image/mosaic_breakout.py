...
def breakout_mosaic():
    ...
    #laptop link
    mosaic_dir = 'C:/SynologyDrive/Programming/msds-thesis-data/data-ml/usga-bennu/'
    ...
    #laptop link
    image_info_save_location = 'C:/SynologyDrive/Programming/msds-thesis-data/data-ml/processed-images-meta/'
    ...
    #laptop link
    mosiac_out_dir = 'C:/SynologyDrive/Programming/msds-thesis-data/data-ml/split-data/bennu-validation/'
    ...
    for row in range(0,image_size[0],480):
        ...
        for col in range(0, image_size[1], 720):
            ...
            PIL.Image.fromarray(image[row:row+480, col:col+720]).save(mosiac_out_dir+f'{counter}.jpg')
            counter += 1
