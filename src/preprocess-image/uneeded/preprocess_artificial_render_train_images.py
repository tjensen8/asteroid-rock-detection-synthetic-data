...
for preprocessing of renderings - applied to train dataset
"""
from preprocess_generator import process_artificial_images

#input directory of rendered images
artificial_image_dir = 'D:/TJPersonalCloud/Programming/msds-thesis-data/data-ml/split-data/train/render-og/'
