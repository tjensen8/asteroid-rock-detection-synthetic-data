...
root_logdir = os.path.join(os.curdir,"modeling","results","custom-modeling","y-model-2-unet", "tflogs-normalize")
...
root_checkpointdir = os.path.join(os.curdir,"modeling","results","custom-modeling","y-model-2-unet", "checkpoints","traintestrun-normalize")
