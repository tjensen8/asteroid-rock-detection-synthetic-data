...
def unet(input_size = (256,256,1)):
    with strategy.scope():
        ...
        up_sample = UpSampling2D(size=(8,8))(pool3)
        #merge = concatenate([up_sample, conv1], axis=-1)
        conv10 = Conv2D(1, 1, activation = 'sigmoid')(up_sample)
...
def do_modeling():
    ...
    root_logdir = os.path.join(os.curdir,"modeling","results","custom-modeling","y-model-1-unet", "tflogs-normalize")
    ...
    root_checkpointdir = os.path.join(os.curdir,"modeling","results","custom-modeling","y-model-1-unet", "checkpoints","traintestrun-normalize")
