...
with strategy.scope():
    ...
    root_logdir = os.path.join(os.curdir,"modeling","results","custom-modeling","y-model-branches-filtersample", "tflogs-normalize")
    ...
    root_checkpointdir = os.path.join(os.curdir,"modeling","results","custom-modeling","y-model-branches-filtersample", "checkpoints", "traintestrun-normalize")
