...
with strategy.scope():
    ...
    root_logdir = os.path.join(os.curdir,"modeling","results","custom-modeling","y-model-branches", "tflogs-normalized")
    ...
    root_checkpointdir = os.path.join(os.curdir,"modeling","results","custom-modeling","y-model-branches", "checkpoints","traintestrun-normalized")
